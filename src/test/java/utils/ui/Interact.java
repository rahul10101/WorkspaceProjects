...
public class Interact {
		...
		public WebElement setElementAndPressEnter(By by, String text) {
			WebDriverWait wait = new WebDriverWait(driver, 60);
			WebElement element = wait.until(ExpectedConditions.elementToBeClickable(by));
		...
		public String getPageTitle() {
			...
			logger.info("Get Title: " + value.toString());
			return value;
		}
		
		public void moveMouseonInfosysServices(By by) {
		...
		public String getCurrentPageURL() {
			...
			logger.info("Get Current Page URL: " + value.toString());
			return value;
		}
